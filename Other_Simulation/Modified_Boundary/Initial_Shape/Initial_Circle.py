...
# Category: Initial Cluster - Circle
# ----------------------------- Basic Info ------------------------------
    ...
    while(True):
        ...
        if(temp == 1):
            if(curDist > R_max*R_max):
                ...
                return 1
        elif(curDist > (min(max(1.3*R_current_max, R_current_max + delta), latticeRange-1)) * (min(max(1.3*R_current_max, R_current_max + delta), latticeRange-1))):
